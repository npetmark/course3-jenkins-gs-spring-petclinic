        ...
        stage("deploy") {
            ...
            steps {
                script{
                    ...
                    copyArtifacts filter: '**/*.jar', fingerprintArtifacts: true, projectName: 'scm-declarative', selector: upstream(allowUpstreamDependencies: true, fallbackToLastSuccessful: true), target: './target'
